defmodule WhistlerNewsReaderWeb.Api.SubscriptionView do
  ...
  def render("show.json", %{subscription: subscription, unread_entries_count: unread_entries_count}) do
    # result = %{subscription: render_one(subscription, WhistlerNewsReaderWeb.Api.FeedView, "subscription.json")}
    result = render("subscription.json", subscription: subscription)
