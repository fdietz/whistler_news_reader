defmodule WhistlerNewsReaderWeb.Api.SubscribedEntryView do
  use WhistlerNewsReaderWeb, :view

  def render("index.json", %{subscribed_entries: subscribed_entries}) do
    %{entries: render_many(subscribed_entries, WhistlerNewsReaderWeb.Api.SubscribedEntryView, "subscribed_entry.json")}
  end

  def render("show.json", %{subscribed_entry: subscribed_entry}) do
    %{entry: render_one(subscribed_entry, WhistlerNewsReaderWeb.Api.SubscribedEntryView, "subscribed_entry.json")}
  end
